...
;
const prisma = global.prisma ?? new __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["PrismaClient"]({
    log: [
        'query',
        'info',
        'warn',
...
async function GET() {
    try {
        ...
        const reservations = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reservation.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__216686._.js.map